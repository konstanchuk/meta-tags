...
{
    const XML_PATH_IS_ENABLED = 'catalog/konstanchuk_metatags_category/active';
    const XML_PATH_REPLACE_TYPE = 'catalog/konstanchuk_metatags_category/replace_type';
    const XML_PATH_META_TITLE = 'catalog/konstanchuk_metatags_category/title';
    const XML_PATH_META_KEYWORDS = 'catalog/konstanchuk_metatags_category/keywords';
    const XML_PATH_META_DESCRIPTION = 'catalog/konstanchuk_metatags_category/description';
    const XML_PATH_ADDITIONAL_META_TAGS = 'catalog/konstanchuk_metatags_category/additional_meta_tags';
